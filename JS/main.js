  ...
  connectedCallback() {
    this.innerHTML = `
        <header>
            <nav class="navbar">
            <div class="logo">
            <a href="index.html"><img src="./Media/logo.svg" alt="DonateNow Logo" class="logo-img"></a>
            </div>
            <ul class="nav-links">
  ...
  connectedCallback() {
    this.innerHTML = `
        ...
        <div class="footer-content">
            ...
            <img src="./Media/logo.svg" alt="DonateNow Logo" class="footer-logo">
                <div class="contact-info">
                    <h3>Contact Information</h3>
                    <p><i class="fas fa-map-marker-alt"></i> Navi Mumbai, Maharashtra, 400037 </p>
                    <p><i class="fas fa-phone"></i> +91 9321871856</p>
                    <p><i class="fas fa-envelope"></i> info@donatenow.org</p>
                </div>
            </div>
